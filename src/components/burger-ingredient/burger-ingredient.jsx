...
export default function BurgerIngredient({ ingredients, ingredient, addIngredient, removeIngredient }) {
  ...
  return (
    <div className={`${burgerIngredient.element} ml-4 mr-4 mb-8`} onClick={handleIngredientClick}>
